...
class XRIntersections extends EventDispatcher {
  ...
  constructor(controller, collisions = []) {
     ...
     * @returns {void}
     */
    this._onControllerSelectEndRef = (event) =>
     ...
     * @returns {void}
     */
    this._onTransientPointerSelectEndRef = (event) =>
      this._onTransientPointerSelectEnd(event);
    ...
    switch (data.targetRayMode) {
      case 'tracked-pointer':
        ...
        controller.addEventListener(
          'selectend',
          this._onControllerSelectEndRef,
        );
      ...
      case 'transient-pointer':
        ...
        controller.addEventListener(
          'selectend',
          this._onTransientPointerSelectEndRef,
        );
  ...
  dispose() {
    ...
    controller.removeEventListener(
      'selectend',
      this.onTransientPointerSelectEndRef,
    );
